...
const run = async () => {
  ...
  const [dsa, dbms, os, cn, se, maths, dsaLab, dbmsLab, webLab, openElective, aimlCore, aimlLab, itCore, itLab, ai] = await Course.create([
    ...
    { code: "CS213", name: "Cloud Foundations", credits: 3, capacity: 40, semester: 3, branch: "CSE", category: "Open Elective", courseKind: "theory", schedule: { days: "Sat", time: "11:45 - 01:15", room: "CSE-211" }, instructor: faculty._id },
    { code: "CS215", name: "Design Thinking for Engineers", credits: 2, capacity: 42, semester: 3, branch: "CSE", category: "Skill Enhancement", courseKind: "theory", schedule: { days: "Fri", time: "03:00 - 04:00", room: "CSE-212" }, instructor: faculty._id },
    { code: "HS203", name: "Professional Communication", credits: 2, capacity: 48, semester: 3, branch: "CSE", category: "Humanities Elective", courseKind: "theory", schedule: { days: "Thu", time: "04:00 - 05:00", room: "HS-102" }, instructor: faculty._id },
